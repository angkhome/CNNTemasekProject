...
#Timestamp : 2018-12-01 01:19:35.713186
#*****************************************
...
metrics=['accuracy'])
model_checkpoints = callbacks.ModelCheckpoint('/content/gdrive/My Drive/CNNProject/SampleOut_2018-12-01_01-19-35.442350/5_Layer3_E30_B64_F64_K55.py_weights_{epoch:02d}_{val_loss:.2f}_Proj.h5', monitor='val_loss',verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
