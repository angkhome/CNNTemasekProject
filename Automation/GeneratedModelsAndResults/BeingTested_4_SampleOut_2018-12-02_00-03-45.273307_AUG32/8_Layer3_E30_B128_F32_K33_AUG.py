#*****************************************
#Author : Hencil Peter
#File Name : 8_Layer3_E30_B128_F32_K33_AUG.py
#Timestamp : 2018-12-02 00:03:45.585115
#*****************************************
...
model_checkpoints = callbacks.ModelCheckpoint('/content/gdrive/My Drive/CNNProject/SampleOut_2018-12-02_00-03-45.273307/8_Layer3_E30_B128_F32_K33_AUG.py_weights_{epoch:02d}_{val_loss:.2f}_Proj.h5', monitor='val_loss',verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
...
fileEvaluation.write('\nFile: 8_Layer3_E30_B128_F32_K33_AUG.py\tAccuracy : ' + str(score[1]) + '\tLoss : ' + str(score[0]) + '\tTraining Time(S) : ' + trainingTime + '')
